...
### Как помогать
Проект работает на [Django 1.11.1](https://docs.djangoproject.com/en/4.0/releases/1.11.1/). Сейчас очень нужна помощь с моделированием системы, почитать о котором можно [здесь](https://docs.djangoproject.com/en/1.11/intro/tutorial02/#craeting-models).
